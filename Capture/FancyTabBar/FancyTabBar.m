...
- (void) calculateExpandedCoordinates{
    ...
    _mainButton.frame = CGRectMake((width -_mainButtonImage.size.width)/2, height - _mainButtonImage.size.height-20, _mainButtonImage.size.width, _mainButtonImage.size.height);
