...
- (void)setupView
{
    self.imageToEditImageView.image = self.currentImage.originalImage;
}
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    [[DropboxManager sharedInstance] removeFileFromPath:self.currentImage.localPath];
}
...
- (void)deletePopUp
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Are you sure?"
                                                    message:[NSString stringWithFormat:@"Do you want to delete this photo?"]
                                                   delegate:self
...
- (IBAction)enhancedTouched:(id)sender
{
    ...
    [photoFilterV showWithImage:self.currentImage.originalImage];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    else
    {
        ...
        [[DropboxManager sharedInstance] deletePath:self.currentImage.dbPath];
          ...
          else
          {
              ...
              UIAlertView *alert =
                  [[UIAlertView alloc] initWithTitle:@"Ooops..."
                                             message:[NSString stringWithFormat:@"Unable to delete file. Error: %@", error.localizedDescription]
                                            delegate:nil
