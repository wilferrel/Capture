...
#define FANCYBAR_HIDDEN \
    CGRectMake(self.fancyTabBar.frame.origin.x, self.fancyTabBar.frame.origin.y + 100, self.fancyTabBar.frame.size.width, self.fancyTabBar.frame.size.height)
#define FANCYBAR_SHOWN \
    CGRectMake(self.fancyTabBar.frame.origin.x, self.fancyTabBar.frame.origin.y - 100, self.fancyTabBar.frame.size.width, self.fancyTabBar.frame.size.height)
